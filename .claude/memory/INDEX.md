...
| DE-007 | OS 쇼핑몰(`/shop`) 안 씀 — 삭제는 **되돌림, 개발자 논의 전 손대지 않음**. 판매는 블랜드픽·산지픽 | `decisions/DE-007-*.md` |
| DE-008 | **정산 계산 한 곳**: 사업자 전액·간이 ÷1.1·프리랜서 ÷1.1 후 3.3% · 작성중→발행→지급 | `decisions/DE-008-*.md` |
...
| IS-007 | **네이버 API 키 인증 실패** — 쇼핑 검색·데이터랩 모두 401. 대표님 키 확인 대기 (트렌드 '얼마나 뜨나'·소싱 가격 조회 막힘) | `issues/IS-007-*.md` |
